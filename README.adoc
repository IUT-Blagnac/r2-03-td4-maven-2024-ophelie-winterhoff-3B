...
On doit changer le <mainclass> dans pom.xml, pour mettre le nom du nouveau fichier java, afin que ça puisse se compiler et s'exécuter.
...
On doit utiliser la commande mvn javadoc:javadoc pour pouvoir générer la javadoc
